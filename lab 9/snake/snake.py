...
class Snake:
    ...
    def move(self):
        global rect_of_head, loser, increaser, gold_eaten,gold_check
...
def lose():
    global segments, snake, previous_key, apples, score, last_score, gold_eaten, gold_timer, timer, apples_gold
    segments = [(width // 2, height // 2)]
